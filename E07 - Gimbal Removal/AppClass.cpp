...
void Application::Display(void)
{
	...
	/*quaternion qOrientation = glm::angleAxis(glm::radians(m_v3Rotation.x), vector3(1.0f, 0.0f, 0.0f));
	qOrientation = glm::angleAxis(glm::radians(m_v3Rotation.y), vector3(0.0f, 1.0f, 0.0f)) * qOrientation;
	qOrientation = glm::angleAxis(glm::radians(m_v3Rotation.z), vector3(0.0f, 0.0f, 1.0f)) * qOrientation;
	*/
